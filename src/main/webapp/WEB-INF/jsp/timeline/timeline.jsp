		...
		<div class="timeline-box my-5">
			...
			<div class="card border rounded mt-3">
				...
				<div class="p-2 d-flex justify-content-between">
					<span class="font-weight-bold" id="userIdSpan">${card.post.userId}</span>
					<span class="postId d-none">${card.post.id}</span>
				...
				<div class="card-img">
					<img src="${card.post.imagePath}" class="img" alt="본문 이미지" width="100" height="100">
				</div>
				</c:if>
				
				<%-- 좋아요 --%>
				<div class="card-like m-3">
				<%-- 빈 하틔 1) 비로그인 2) 좋아요를 누르지 않았을 때 --%>
				<c:if test="${card.filledLike eq false}"> <%-- null 이거나 비어있거나 --%>
					<a href="#" class="like-btn" data-post-id="${card.post.id}">
						<img src="https://www.iconninja.com/files/214/518/441/heart-icon.png" width="18" height="18" alt="not filled heart">
					</a>
				</c:if>
